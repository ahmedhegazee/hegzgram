        ...
        <div class="row">
            ...
            <div class="col-9 pt-5">
                ...
                <div class="d-flex">
                    ...
                    <a href="<?php echo e(route('profile.followers',['profile'=>$user->username])); ?>" class="pr-5"><strong><?php echo e($followersCount); ?></strong> followers</a>
                    <a href="<?php echo e(route('profile.followings',['profile'=>$user->username])); ?>" class="pr-5"><strong><?php echo e($followeringsCount); ?></strong> following</a>
                </div>
                ...
                <?php $__currentLoopData = $user->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-4 pb-5">
                        <a href="<?php echo e(route('post.show',['post'=>$post->id])); ?>">
                            <img src="<?php echo e($post->postImage()); ?>" class="w-100">
                        </a>
